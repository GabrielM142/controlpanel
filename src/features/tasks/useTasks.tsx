...
const seed:Task[]=[
 ...
 {id:'t3',title:'Aprobar propuesta Nova Business — alertas WhatsApp',description:'Revisar cotización final y respuesta antes del viernes.',createdAt:new Date(Date.now()-86400000*4).toISOString(),updatedAt:new Date(Date.now()-86400000*4).toISOString(),priority:'media',status:'pending',linkedPageId:'trueque-list',dueDate:new Date(Date.now()+86400000*3).toISOString().slice(0,10)},
